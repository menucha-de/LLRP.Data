...
public enum C1G2BlockWriteOpSpecResultValues {
	...
	private C1G2BlockWriteOpSpecResultValues(short value) {
		this.value = value;
	}
	...
	public static C1G2BlockWriteOpSpecResultValues get(short value) {
		for (C1G2BlockWriteOpSpecResultValues resultValues : C1G2BlockWriteOpSpecResultValues.values()) {
